...
class ControlJoints:
    def __init__(self, arm_type):
        ...
        self._joint_names = [str(arm_type) + '_arm_1_joint', str(arm_type) + '_arm_2_joint',
                             str(arm_type) + '_arm_3_joint', str(arm_type) + '_arm_4_joint',
                             str(arm_type) + '_arm_5_joint', str(arm_type) + '_arm_6_joint',
    ...
    def spinOnce(self):
        ...
        self.move_joint(str(self.arm_type) + '_arm_1_joint', 1.0, 3)
        rospy.sleep(5)
